...
- chore: ensure compatibility with ansible 2.19
- chore: cleanup ansible-lint warnings
- fix: properly set file mode for secret files and directories
- testing: add tests for ansible 2.18 and 2.19
